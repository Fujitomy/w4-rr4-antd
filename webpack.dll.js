...
module.exports = {
    ...
    entry: {
        // 抽离公共包文件名和模块
        vendor: ['react', 'react-dom', 'react-router','react-router-dom','react-loadable','axios',]
    },
    output: {
        // 输出文件路径
...
// 这个数据集合称为 "Manifest"，当完成打包并发送到浏览器时，会在运行时通过 Manifest 来解析和加载模块。无论你选择哪种模块语法，那些 import 或 require 语句现在都已经转换为 __webpack_require__ 方法，此方法指向模块标识符(module identifier)。
