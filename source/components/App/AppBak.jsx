...
class App extends React.Component {
    ...
    componentDidMount(){
        ...
        Mock.mock('http://localhost:8088/nihao', {
            'list|1-10': [{
                'id|+1': 1,
                'email': '@EMAIL'
            }]
        ...
        $.ajax({
            ...
            crossDomain: true,
            success:function(e){
                console.log(e,'----------jquery数据')
            },
            error:(error)=>{
                console.log(error,'----------jquery数据错误')
            }
        })
            ...
            <HashRouter basename='manage' >
                <main className='main' ref={this.main}>
                    ...
                    <aside>
                        ...
                        <h1 style={{width: 'auto'||'750px',background:'orange'}}>
                            {`设备独立像素 device dependent pixel 获取 screen.width:`}<br/>
                            { screen.width }<br/>
                            { this.state.screenWidth || '--' }
                        </h1>
                        <div className='one-rem'>
                            1rem*1rem
                        </div>
                        <div className='onehundred-rem'>
                            1rem*1rem
                        </div>
                        <br/>
                        ...
                        <br/>
                        <h1 style={{width: 'auto'||'100vw',background:'orange'}}>
